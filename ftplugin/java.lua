...
local lombok_path = vim.fn.stdpath "data"
  .. "/mason/packages/lombok-nightly/"
...
local equinox_path =
  vim.split(
    vim.fn.glob(
      vim.fn.stdpath "data"
        .. "/mason/packages/jdtls/plugins/*jar"
    ),
    "\n"
  )
...
local config =
  {
    ...
    settings = {
      ...
      extendedClientCapabilities = require(
        "jdtls"
