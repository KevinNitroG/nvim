...
return {
  ...
  opts = function(
    ...
    opts.completion["completeopt"] =
      "menu,menuone,noselect" -- disable autoselect
    ...
    if
      vim.g.border_enabled
    then
      opts.window =
        {
          completion = require(
            "cmp"
          ).config.window.bordered(),
  ...
  dependencies = {
    ...
    -- Commandline completions
    {
      "hrsh7th/cmp-cmdline",
      config = function()
        local cmdline_mappings = vim.tbl_extend(
          "force",
          {},
          require(
            "cmp"
