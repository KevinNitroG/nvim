...
local os = sysname:match "Windows"
    and "Windows"
  or sysname:match "Linux" and "Linux"
  or sysname -- Windows, Linux, Darwin, NetBSD,...
local is_windows = os
  == "Windows"
...
local global =
  {
    ...
    snipmate_snippets_path = vim.fn.stdpath "config"
      .. "/snippets/snipmate", -- path to snipmate snippets
    ...
    toggle_theme_icon = "   ",
    base46_cache = vim.fn.stdpath "data"
      .. "/nvchad/base46/",
