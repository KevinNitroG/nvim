...
command(
  ...
  {
    desc = "Edit the available snippets in the filetype",
  }
)
...
command(
  ...
  function(
    ...
    local prefix = args.line1
      .. ","
      .. args.line2
    local chars = args.fargs[1]
          ~= nil
        and args.fargs[1]
      or ";"
    vim.cmd(
  ...
  {
    nargs = "?",
    desc = 'Append char(s) to end of each line (Default: ";")',
    range = true,
  }
)
